...
export default async function ReportCardPage({ params }) {
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 print:shadow-none print:border-none">
        <div className="text-center border-b border-gray-200 pb-6 mb-6">
          ...
          <p className="text-gray-500 text-sm mt-2">Result Sheet</p>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 flex justify-between text-xs text-gray-400">
          <span>Nishant PG College Software</span>
