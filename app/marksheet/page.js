  ...
  return (
    <div>
      <div className="mb-4">
        ...
        <p className="text-gray-500 text-xs mt-0.5">Internal · Mid Term · Annual</p>
      </div>
        ...
        <form method="GET" action="/marksheet/view" className="space-y-3">
              ...
              {examTypes.map(({ val, label }) => (
                <label key={val}
                  ...
                  <input type="radio" name="type" value={val}
                    defaultChecked={selectedType === val} className="accent-indigo-600" />
          ...
          <div>
            ...
            {years.length > 0 ? (
              ...
              <input type="text" name="year" defaultValue={selectedYear} placeholder="e.g. 2024-25"
                className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400" />
            )}
          </div>
