// app/students/add/AddStudentForm.js
"use client";
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        <form action={addStudent} className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <button
              type="submit"
              className="flex-1 bg-indigo-600 text-white py-2.5 rounded-lg hover:bg-indigo-700 active:bg-indigo-800 text-sm font-medium transition"
            >
              Save Student
            </button>
            <a
