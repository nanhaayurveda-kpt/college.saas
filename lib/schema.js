...
export const students = sqliteTable(
  "students",
  {
    ...
    admission_no: text("admission_no").unique(),
    pen: text("pen"),
...
export const professors = sqliteTable("professors", {
  ...
  designation: text("designation").default("assistant"),
  pin: text("pin").unique(),
});
...
export const fee_structures = sqliteTable("fee_structures", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  course: text("course").notNull(),
  fee_type: text("fee_type").notNull().default("tuition"),
  amount: integer("amount").notNull(),
  academic_year: text("academic_year"),
  created_at: integer("created_at", { mode: "timestamp" }).defaultNow(),
});
...
export const period_timings = sqliteTable("period_timings", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  period_no: integer("period_no").notNull().unique(),
  start_time: text("start_time").notNull(),
  end_time: text("end_time").notNull(),
